Dwarf Fortress raw-xml Converter v1.30 2013-05-03
...
The folders "in" "out" "out/Y" and "out/N" all need to exist in the parent directory in order for the tools to work correctly.  
