...
public class Bifurcator extends javax.swing.JFrame {
						...
						if( root != null ){
							...
							if(root1.getChildCount()>0){
								...
								for(int j=0; j<root1.getChildCount(); j++)
									output1 = output1 + "\t" + root1.getChildAt(j).getArgument(1) + "\n";
							...
							if(root2.getChildCount()>0){
								...
								for(int j=0; j<root2.getChildCount(); j++)
									output2 = output2 + "\t" + root2.getChildAt(j).getArgument(1) + "\n";
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(Bifurcator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
